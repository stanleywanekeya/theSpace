...
def index():
    ...
    return render_template('index.html', title='theSpace', form=form, 
...
def edit_profile():
    """Function to edit the profile page of user"""
...
@login_required
def user(username):
    """Function to visit the user profile"""
...
@app.before_request
def before_request():
    """carries out task before request"""
    if current_user.is_authenticated:
